        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObraSocial = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Turnos_ProfesionalId_PacienteId",
                table: "Turnos",
                columns: new[] { "ProfesionalId", "PacienteId" },
                unique: true,
                filter: "\"Estado\" < 2");
